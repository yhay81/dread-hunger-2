...
void UFrostwakeServerConfigSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
...
FString UFrostwakeServerConfigSubsystem::ResolveConfigPath() const
{
    FString ConfigPath;
...
bool UFrostwakeServerConfigSubsystem::LoadFromJsonFile(const FString& ConfigPath)
{
    FString JsonText;
    ...
    {
        UE_LOG(LogFrostwakeSession, Warning, TEXT("Failed to parse server config JSON path=%s"), *ConfigPath);
        return false;
    }
