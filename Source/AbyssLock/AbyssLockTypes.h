...
UENUM(BlueprintType)
enum class EAbyssMatchMode : uint8
{
...
// Difficulty preset. Populates the tuning fields of FAbyssMatchConfig.
UENUM(BlueprintType)
enum class EAbyssDifficulty : uint8
{
...
struct FAbyssMatchConfig
{
    ...
    EAbyssMatchMode Mode = EAbyssMatchMode::Standard;

    // Difficulty preset that fills the tuning fields below.
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Abyss|Match")
    EAbyssDifficulty Difficulty = EAbyssDifficulty::Normal;
