...
- ステータス: **v0.8**（2026-05-30）。上記＋**teardown 機能パリティ cross-check**（裏切り者の欠落スロット補完 Smother/Slip/Mirage・混成cast・船区画・意図的divergence 確認）。残は人間レビュー/GP-03実装値/C++配線。
...
| ファイル | 中身 | 状態 |
| --- | --- | --- |
| `README.md` | 索引・確定方向・IPガードレール・整合メモ | v0.8 |
