...
Current snapshot: 2026-05-25 JST. Re-check listing price, license, compatibility, AI flags, and package contents immediately before purchase or import.
...
| 2 | Sci-fi Rooms and Corridors Interior Kit | 78 | First paid interior candidate | Strong modular near-future corridors and rooms; must be grounded away from orbital spaceship visuals |
| 3 | Plan V: Arctic Settlement Kit | 72 | Exterior/deck candidate after interior POC | Useful snow/industrial exterior dressing; keep ship as the main identity |
