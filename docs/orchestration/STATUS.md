...
| **GP-03** Core Match | 🟡 YELLOW | Sabotage loss explainable from in-match signals | Audit `match_ended` `fatal_ship_state` payload → `docs/gp03-endstate-readability-audit.md` | Human P1-024/025 readability notes don't exist yet | 2026-05-29 |
