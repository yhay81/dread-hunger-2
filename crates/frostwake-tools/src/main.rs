...
struct LocalSmokeOptions {
    ...
    smoke_survival: bool,
    smoke_effect: bool,
    smoke_perk_resist: bool,
    smoke_ability: bool,
    smoke_inventory: bool,
    smoke_held_item: bool,
    no_auto_start: bool,
    auto_ready: bool,
...
fn default_local_smoke_options() -> LocalSmokeOptions {
    LocalSmokeOptions {
        ...
        smoke_effect: false,
        smoke_perk_resist: false,
        smoke_ability: false,
        smoke_inventory: false,
        smoke_held_item: false,
        no_auto_start: false,
        auto_ready: false,
...
fn parse_local_smoke_args(args: &[String]) -> Result<(LocalSmokeOptions, bool), String> {
    ...
    while index < args.len() {
        ...
        match arg {
            ...
            "--smoke-perk-resist" => options.smoke_perk_resist = true,
            "--smoke-ability" => options.smoke_ability = true,
            "--smoke-inventory" => options.smoke_inventory = true,
            "--smoke-held-item" => options.smoke_held_item = true,
...
fn run_local_smoke(options: &LocalSmokeOptions) -> Result<(), String> {
    ...
    for (enabled, flag) in [
        ...
        (options.smoke_perk_resist, "-FrostwakeSmokePerkResist"),
        (options.smoke_ability, "-FrostwakeSmokeAbility"),
        (options.smoke_inventory, "-FrostwakeSmokeInventory"),
        (options.smoke_held_item, "-FrostwakeSmokeHeldItem"),
    ...
    let result = (|| -> Result<(), String> {
        ...
        let smoke_checks = [
            ...
            (
                options.smoke_ability,
                &["dev_smoke_ability result=pass"][..],
                "ability smoke",
            ),
            (
                options.smoke_inventory,
                &["dev_smoke_inventory result=pass"][..],
                "inventory stacking smoke",
            ),
            (
                options.smoke_held_item,
                &["dev_smoke_held_item result=pass"][..],
                "held item smoke",
            ),
        ];
